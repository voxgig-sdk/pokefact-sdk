...
func (sdk *PokefactSDK) OptionsMap() map[string]any {
...
func (sdk *PokefactSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PokefactSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PokefactSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PokefactSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PokefactSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PokefactSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PokefactSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PokefactSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PokefactSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PokefactSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
