...
func registerSDKWords(r *eng.Registry, client *sdk.PokefactSDK) {
...
func runOp(client *sdk.PokefactSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
