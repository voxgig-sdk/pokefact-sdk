...
AQL-driven CLI and REPL for the Pokefact SDK. Positional arguments are
...
./pokefact-cli load 1 get_random_pokemon_fact
./pokefact-cli load '{id:1}' get_random_pokemon_fact
