...
|---|---|---|
| `ts/` | @voxgig-sdk/pokefact-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/pokefact-sdk \
      --repository voxgig-sdk/pokefact-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/pokefact-sdk` shows it, and
`npm trust revoke @voxgig-sdk/pokefact-sdk --id=<id>` removes it.
