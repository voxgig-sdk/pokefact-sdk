...
from projectname_sdk import PokefactSDK
from projectname_sdk.core.spec import PokefactSpec
from projectname_sdk.core.result import PokefactResult
from projectname_sdk.core.response import PokefactResponse
from projectname_sdk.core.operation import PokefactOperation
from projectname_sdk.core.error import PokefactError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import PokefactBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = PokefactSDK.test(None, None)
        ...
        class TestInitFeature(PokefactBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PokefactBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PokefactSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PokefactSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PokefactSDK.test(None, setup_opts)
