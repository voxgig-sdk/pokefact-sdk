...
from projectname_sdk.core.control import PokefactControl
...
class PokefactContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, PokefactResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PokefactResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PokefactError(code, msg, self)
