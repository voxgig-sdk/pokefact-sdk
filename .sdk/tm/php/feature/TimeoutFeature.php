...
class PokefactTimeoutFeature extends PokefactBaseFeature
{
    ...
    private function _with_timeout(PokefactContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PokefactContext $_ctx, float $ms): void
    {
        $client = $this->client;
