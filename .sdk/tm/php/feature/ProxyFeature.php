...
class PokefactProxyFeature extends PokefactBaseFeature
{
    ...
    public function init(PokefactContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PokefactContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
