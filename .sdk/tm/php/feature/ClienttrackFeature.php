...
// Pokefact SDK clienttrack feature
...
class PokefactClienttrackFeature extends PokefactBaseFeature
{
    ...
    public function PostConstruct(PokefactContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Pokefact-SDK';
