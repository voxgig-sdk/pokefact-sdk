...
// Pokefact SDK streaming feature
...
class PokefactStreamingFeature extends PokefactBaseFeature
{
    ...
    private function _iterate(PokefactResult $result): \Generator
    {
    ...
    private function _streamable(PokefactContext $ctx): bool
    {
