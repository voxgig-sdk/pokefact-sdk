...
// Pokefact SDK ratelimit feature
...
class PokefactRatelimitFeature extends PokefactBaseFeature
{
    ...
    private function _acquire(PokefactContext $ctx): void
    {
    ...
    private function _track(PokefactContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
