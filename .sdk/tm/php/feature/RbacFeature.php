...
class PokefactRbacFeature extends PokefactBaseFeature
{
    ...
    private function _required(PokefactContext $ctx): ?string
    {
    ...
    private function _reject(PokefactContext $ctx, string $required): void
    {
    ...
    private function _track(PokefactContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
