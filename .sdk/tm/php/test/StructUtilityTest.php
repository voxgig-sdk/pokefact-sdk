...
// Pokefact SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PokefactOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PokefactOmni::structfix($now, Struct::undef()))
                        !== json_encode(PokefactOmni::structfix($val, Struct::undef()))) {
