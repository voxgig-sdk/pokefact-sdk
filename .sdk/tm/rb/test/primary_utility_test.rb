...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = PokefactOmni.make_runner(TEST_JSON_FILE, PokefactSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : PokefactOmni.errify(err)
    end
