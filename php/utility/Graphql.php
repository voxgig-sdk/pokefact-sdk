...
class PokefactGraphql
{
    ...
    // equivalent.
    public static function body(PokefactContext $ctx): mixed
    {
    ...
    public static function errors(PokefactContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
