...
// Pokefact SDK utility: fetcher

class PokefactFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PokefactSDK/1.0)';
    ...
    public static function call(PokefactContext $ctx, string $fullurl, array $fetchdef): array
    {
