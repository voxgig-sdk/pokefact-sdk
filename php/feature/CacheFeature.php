...
class PokefactCacheFeature extends PokefactBaseFeature
{
    ...
    private function _through(PokefactContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
