...
// Pokefact SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PokefactTestFeature extends PokefactBaseFeature
{
    ...
    public function init(PokefactContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PokefactContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PokefactContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PokefactContext $ctx, $op, $args): array
    {
