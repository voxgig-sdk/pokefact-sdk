...
{
    private static function utility(): PokefactUtility
    {
        return new PokefactUtility();
    }
    ...
    private static function ctx(array $over = []): PokefactContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PokefactContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PokefactOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PokefactError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PokefactOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PokefactMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PokefactOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PokefactMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PokefactOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PokefactMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PokefactSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PokefactMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = PokefactMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PokefactSpec([]),
            'response' => null,
            'result' => new PokefactResult([]),
        ]);
        [, $err] = PokefactMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PokefactSpec(['step' => 's']),
            'response' => new PokefactResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PokefactResult([]),
        ]);
        [, $err] = PokefactMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PokefactSpec(['step' => 's']),
            'response' => new PokefactResponse(self::resp(200, ['v' => 1])),
            'result' => new PokefactResult([]),
        ]);
        [, $err] = PokefactMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PokefactSpec(['step' => 's']),
            'response' => new PokefactResponse(self::resp(200, ['v' => 2])),
            'result' => new PokefactResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PokefactMakeResponse::call($ctx);
    ...
    {
        $preset = new PokefactResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PokefactSpec([]),
            'response' => new PokefactResponse([]),
            'result' => new PokefactResult([]),
        ...
        [$got, $err] = PokefactMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PokefactResult([])]);
        [, $err] = PokefactMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PokefactSpec([]), 'result' => null]);
        [, $err] = PokefactMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PokefactSpec(['step' => 's']),
            'result' => new PokefactResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PokefactOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PokefactMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PokefactSpec(['step' => 's']),
            'result' => new PokefactResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PokefactOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PokefactMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PokefactResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PokefactSpec([]),
            'result' => new PokefactResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PokefactMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PokefactMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PokefactError('boom', 'boom');
        $utility->fetcher = function (PokefactContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PokefactSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PokefactMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PokefactContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PokefactMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PokefactResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PokefactContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PokefactSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PokefactMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PokefactResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PokefactSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PokefactMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PokefactMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PokefactMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PokefactResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PokefactDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PokefactResult(['ok' => false])]);
        $this->expectException(PokefactError::class);
        PokefactDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PokefactResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PokefactMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PokefactMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PokefactBaseFeature();
        $b = new PokefactBaseFeature();
        PokefactFeatureAdd::call($ctx, $a);
        PokefactFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PokefactBaseFeature
    {
        $f = new PokefactBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PokefactFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PokefactContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PokefactSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PokefactPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PokefactResponse(['headers' => null]),
            'result' => new PokefactResult([]),
        ]);
        PokefactResultHeaders::call($ctx);
