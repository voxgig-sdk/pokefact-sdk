...
class PokefactTestRunner
{
    ...
    {
        $live = self::getenv('POKEFACT_TEST_LIVE');
        $override = self::getenv('POKEFACT_TEST_OVERRIDE');
        ...
        $explain = self::getenv('POKEFACT_TEST_EXPLAIN');
...
class_alias('PokefactTestRunner', 'Runner');
class_alias('PokefactHelpers', 'Helpers');
