...
// Pokefact SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PokefactSDK::test)
...
{
    private const SDK_CLASS = 'PokefactSDK';
    ...
    private const SDK_BASE = 'pokefact_sdk';
