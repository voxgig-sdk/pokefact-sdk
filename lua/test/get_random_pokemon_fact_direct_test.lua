...
describe("GetRandomPokemonFactDirect", function()
  it("should direct-list-get_random_pokemon_fact", function()
    local setup = get_random_pokemon_fact_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_random_pokemon_fact", setup.live and "live" or "unit")
