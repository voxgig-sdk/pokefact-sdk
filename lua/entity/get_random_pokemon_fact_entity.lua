...
local GetRandomPokemonFactEntity = {}
GetRandomPokemonFactEntity.__index = GetRandomPokemonFactEntity


function GetRandomPokemonFactEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetRandomPokemonFactEntity)
  self._name = "get_random_pokemon_fact"
  self._client = client
...
function GetRandomPokemonFactEntity:get_name()
  return self._name
end


function GetRandomPokemonFactEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetRandomPokemonFactEntity.new(self._client, opts)
end
...
function GetRandomPokemonFactEntity:mark_deleted()
  self._deleted = true
end


function GetRandomPokemonFactEntity:deleted()
  return true == self._deleted
end


function GetRandomPokemonFactEntity:data_set(args)
  if args ~= nil then
...
function GetRandomPokemonFactEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetRandomPokemonFactEntity:match_set(args)
  if args ~= nil then
...
function GetRandomPokemonFactEntity:match_get()
...
function GetRandomPokemonFactEntity:stream(action, args, callopts)
...
function GetRandomPokemonFactEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetRandomPokemonFactEntity
