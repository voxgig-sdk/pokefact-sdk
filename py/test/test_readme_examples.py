# Pokefact SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PokefactSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PokefactSDK(...) and PokefactSDK.test(...) become
#      PokefactSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "pokefact_sdk"
_SDK_CLASS = "PokefactSDK"
...
_ENTITIES = {
    "GetRandomPokemonFact": "get_random_pokemon_fact",
}
