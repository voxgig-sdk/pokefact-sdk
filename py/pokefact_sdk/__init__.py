...
from pokefact_sdk.utility import register

# Load features
from pokefact_sdk.feature.base_feature import PokefactBaseFeature
from pokefact_sdk.features import _has_feature, _make_feature
...
class PokefactSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PokefactUtility()
        self._utility = utility

        from pokefact_sdk.config import shared_config
    ...
    def get_utility(self):
        return PokefactUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PokefactSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetRandomPokemonFact(self, data=None) -> "GetRandomPokemonFactEntity":
        ...
        from pokefact_sdk.entity.get_random_pokemon_fact_entity import GetRandomPokemonFactEntity
