...
from pokefact_sdk.pokefact_types import (
...
class GetRandomPokemonFactEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetRandomPokemonFactEntity(self._client, opts)
    ...
    def data_get(self) -> GetRandomPokemonFact:
    ...
    def match_get(self) -> GetRandomPokemonFact:
