...
module PokefactTestRunner
  ...
  def self.env_override(m)
    live = getenv("POKEFACT_TEST_LIVE")
    override = getenv("POKEFACT_TEST_OVERRIDE")
    ...
    explain = getenv("POKEFACT_TEST_EXPLAIN")
    m["POKEFACT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PokefactTestRunner
Helpers = PokefactHelpers
Vs = VoxgigStruct
