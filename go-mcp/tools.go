...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_random_pokemon_fact"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PokefactSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "pokefact_list",
		Description: "List records from Pokefact. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "pokefact_load",
		Description: "Load a single record from Pokefact. " +
...
func runOp(client *sdk.PokefactSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PokefactSDK, name string) (sdk.PokefactEntity, error) {
	switch strings.ToLower(name) {
	case "get_random_pokemon_fact":
		return client.GetRandomPokemonFact(nil), nil
