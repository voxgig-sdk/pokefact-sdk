...
function envOverride(m) {
    if ('TRUE' === process.env.POKEFACT_TEST_LIVE ||
        'TRUE' === process.env.POKEFACT_TEST_OVERRIDE) {
    ...
    m.POKEFACT_TEST_EXPLAIN = process.env.POKEFACT_TEST_EXPLAIN || m.POKEFACT_TEST_EXPLAIN;
    return m;
}
