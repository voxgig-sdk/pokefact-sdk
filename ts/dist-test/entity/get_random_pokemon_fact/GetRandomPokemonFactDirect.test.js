...
(0, node_test_1.describe)('GetRandomPokemonFactDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_random_pokemon_fact', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_random_pokemon_fact', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.POKEFACT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PokefactSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['POKEFACT_TEST_GET_RANDOM_POKEMON_FACT_ENTID'];
    ...
    const client = new __1.PokefactSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetRandomPokemonFactDirect.test.js.map